	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(request.getSession().getAttribute("loggato").equals("no"))
		{
			...
			case "accesso" :
				...
				if(user.equals("mario") && pass.equals("mariottide"))
		...
		if(request.getSession().getAttribute("loggato").equals("si"))
		{
			...
			case "topinfocorso" :
				...
				//ris = v.graficaTopInfoCorso(Integer.parseInt(request.getParameter("cod")));	
			...
			case "infocorso" :
				...
				//ris = v.graficaInfoCorso(Integer.parseInt(request.getParameter("cod"))) ;
